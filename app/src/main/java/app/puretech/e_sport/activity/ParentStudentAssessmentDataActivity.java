...
public class ParentStudentAssessmentDataActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_parent_student_assessment_data);
        doInit();
    ...
    private void doInit() {
        ...
        i_back = new Intent(activity, ParentStudentAssessmentActivity.class);
    ...
    private void getAssessmentActivity(String str_school_id, String str_student_id, String str_term) {
        ...
        Log.d("ddddd", "getAssessmentActivity: "+str_school_id);
        Log.d("ddddd", "getAssessmentActivity: "+str_student_id);
        Log.d("ddddd", "getAssessmentActivity: "+str_term);
            ...
            public void onValueSelected(Entry e, int dataSetIndex, Highlight h) {
                ...
                for (int i = 0; i < arrayList.size(); i++) {
                    ...
                    if (str_name.equals(NameOfActivity.get(h.getXIndex()))) {
                        ...
                        Intent i_next = new Intent(getApplicationContext(), ParentStudentAssessmentBarActivity.class);
