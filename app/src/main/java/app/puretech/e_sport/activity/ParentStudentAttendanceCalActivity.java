...
public class ParentStudentAttendanceCalActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      /*  getWindow().setFlags(WindowManager.LayoutParams.FLAG_SECURE,
        ...
        setContentView(R.layout.activity_parent_student_attendance_cal);
        doInit();
    ...
    private void getSessiondata(String student_id, String attendance_date, String attendance_type) {
        if (CommonUtil.isNetworkAvailable(activity)) {
            ...
            RequestBody requestBody = new MultipartBuilder()
                    ...
                    .build();
            app.getApiService().getParentSession(requestBody).enqueue(new Callback<Map<String, Object>>() {
                @Override
    ...
    private void getCalData(String str_trainer_id, String str_month) {
        if (CommonUtil.isNetworkAvailable(activity)) {
            ...
            RequestBody requestBody = new MultipartBuilder()
                    ...
                    .addFormDataPart("school_id",AppPreferences.init(activity).getString("school_id",""))
                    .build();
            app.getApiService().getParentAttendanceCal(requestBody).enqueue(new Callback<Map<String, Object>>() {
                @Override
                public void onResponse(Response<Map<String, Object>> response, Retrofit retrofit) {
                    if (response.body() != null) {
                        app.getLogger().error("success");
