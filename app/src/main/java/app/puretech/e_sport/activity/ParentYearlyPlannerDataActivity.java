...
public class ParentYearlyPlannerDataActivity extends AppCompatActivity {
    App app;
    Activity activity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_parent_yearly_planner_data);
        doInit();
    }
    private void doInit() {
        ...
        i_back = new Intent(activity, ParentYearlyPlannerActivity.class);
