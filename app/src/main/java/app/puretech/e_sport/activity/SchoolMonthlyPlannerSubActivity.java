...
public class SchoolMonthlyPlannerSubActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      /*  getWindow().setFlags(WindowManager.LayoutParams.FLAG_SECURE,
        ...
        setContentView(R.layout.activity_school_monthly_planner_sub);
        doInit();
    }
    ...
    private void doInit() {
        ...
        i_back = new Intent(activity, SchoolMonthlyPlannerActivity.class);
        ...
        doBack(toolbar);
        getMonthlyPlanner(tv_trainer_monthly_planner_month.getText().toString(), AppPreferences.init(activity).getString("class",""),AppPreferences.init(activity).getString("trainer_id",""));
    }
    private void getMonthlyPlanner(String str_month, String str_class, String trainer_id) {
