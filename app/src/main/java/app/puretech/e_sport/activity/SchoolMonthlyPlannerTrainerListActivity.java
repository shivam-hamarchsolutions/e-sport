...
public class SchoolMonthlyPlannerTrainerListActivity extends AppCompatActivity {
    private App app;
    private Activity activity;
    private RecyclerView rv_show;
    private List<SchoolTrainerDailyReportDTO> array_list = new ArrayList<>();
    private SchoolTrainerListMonthlyPlannerAdapter schoolTrainerDailyReportAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_school_monthly_planner_trainer_list);
        doInit();
    }
    private void doInit() {
    ...
    private void setAdapter() {
        schoolTrainerDailyReportAdapter = new SchoolTrainerListMonthlyPlannerAdapter(array_list, activity);
