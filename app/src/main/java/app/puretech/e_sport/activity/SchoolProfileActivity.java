...
public class SchoolProfileActivity extends AppCompatActivity {
    ...
    private TextView tv_school_name,tv_email,tv_mobile,tv_addresss;
    @Override
    ...
    private void doInit() {
        ...
        activity = this;
        civ_User_Profile = findViewById(R.id.civ_profile);
        tv_school_name = findViewById(R.id.tv_school_name);
        tv_email = findViewById(R.id.tv_email);
        tv_mobile = findViewById(R.id.tv_mobile);
        tv_addresss = findViewById(R.id.tv_address);
        toolbar = findViewById(R.id.toolbar_home);
        iBack = new Intent(activity, SchoolHomeActivity.class);
        doBack(toolbar);
        ImageUtil.displayImageSchool(civ_User_Profile, AppPreferences.init(activity).getString("school_pic",""),null);
        tv_school_name.setText(AppPreferences.init(activity).getString("school_name",""));
        tv_email.setText(AppPreferences.init(activity).getString("school_email",""));
        tv_mobile.setText(AppPreferences.init(activity).getString("school_contact",""));
        tv_addresss.setText(AppPreferences.init(activity).getString("school_address",""));
