...
public class SchoolStudentActivityAssessmentActivity extends AppCompatActivity {
    private App app;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_school_student_assessment2);
    ...
    private void doInit() {
        ...
        i_back = new Intent(activity, SchoolStudentAssessmentListActivity.class);
            ...
            public void onValueSelected(Entry e, int dataSetIndex, Highlight h) {
                ...
                for (int i = 0; i < arrayList.size(); i++) {
                    ...
                    if (str_name.equals(NameOfActivity.get(h.getXIndex()))) {
                        ...
                        Intent i_next = new Intent(getApplicationContext(), SchoolStudentActivityAssessmentBarchartActivity.class);
