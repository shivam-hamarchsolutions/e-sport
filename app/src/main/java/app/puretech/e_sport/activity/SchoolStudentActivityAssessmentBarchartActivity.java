...
public class SchoolStudentActivityAssessmentBarchartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_school_student_assessment_barchart);
    ...
    private void doInit() {
        ...
        i_back = new Intent(activity, SchoolStudentActivityAssessmentActivity.class);
