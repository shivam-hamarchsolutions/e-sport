...
import app.puretech.e_sport.adapter.SchoolStudentAssessmentLlistAdapter;
...
public class SchoolStudentAssessmentListActivity extends AppCompatActivity {

    App app;
    Activity activity;
    private RecyclerView rv_show;
    private List<TrainerSchoolAssessmentListDTO> array_list = new ArrayList<>();
    private SchoolStudentAssessmentLlistAdapter schoolStudentAssessmentLlistAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_school_student_assessment_list);
    ...
    private void doInit() {
        ...
        iBack = new Intent(activity, SchoolStudentAssessmentActivity.class);
    ...
    private void setAdapter() {
        schoolStudentAssessmentLlistAdapter = new SchoolStudentAssessmentLlistAdapter(array_list, activity);
        RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(getApplicationContext());
        rv_show.setLayoutManager(mLayoutManager);
        rv_show.setItemAnimator(new DefaultItemAnimator());
        rv_show.setAdapter(schoolStudentAssessmentLlistAdapter);
        if (schoolStudentAssessmentLlistAdapter.getItemCount() == 0) {
