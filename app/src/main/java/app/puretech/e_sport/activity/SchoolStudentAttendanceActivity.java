...
public class SchoolStudentAttendanceActivity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* getWindow().setFlags(WindowManager.LayoutParams.FLAG_SECURE,
        ...
        setContentView(R.layout.activity_school_student_attendance);
        doInit();
        getClassDivision();
        btn_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i_next = new Intent(activity, SchoolStudentListActivity.class);
