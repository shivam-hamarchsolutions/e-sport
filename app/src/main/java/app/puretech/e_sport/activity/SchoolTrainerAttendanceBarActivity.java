...
public class SchoolTrainerAttendanceBarActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* getWindow().setFlags(WindowManager.LayoutParams.FLAG_SECURE,
        ...
        setContentView(R.layout.activity_school_trainer_attendance_bar);
        doInit();
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.toolbar_home:
                Intent i = new Intent(activity, SchoolTrainerAttendanceActivity.class);
                activity.startActivity(i);
                activity.finish();
                break;
        }
