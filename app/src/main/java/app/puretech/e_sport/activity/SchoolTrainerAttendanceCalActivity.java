...
public class SchoolTrainerAttendanceCalActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* getWindow().setFlags(WindowManager.LayoutParams.FLAG_SECURE,
        ...
        setContentView(R.layout.activity_school_trainer_attendance_cal);
        doInit();
    ...
    public void onBackPressed() {
        Intent i = new Intent(activity, SchoolTrainerAttendanceBarActivity.class);
