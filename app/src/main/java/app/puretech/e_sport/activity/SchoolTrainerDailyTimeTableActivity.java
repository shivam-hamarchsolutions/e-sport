...
public class SchoolTrainerDailyTimeTableActivity extends AppCompatActivity {
    private App app;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_school_trainer_daily_time_table);
        ...
        if (CommonUtil.isNetworkAvailable(activity)) {
            ...
            app.getApiService().getTrainerList().enqueue(new Callback<Map<String, Object>>() {
                ...
                public void onFailure(Throwable t) {
                    ...
                    dialog.dismiss();
                    Toast.makeText(app, "Something went wrong,plese try again!", Toast.LENGTH_SHORT).show();
                }
            });
        } else {
