...
import app.puretech.e_sport.adapter.SchoolTrainerListMonthlyPlannerAdapter;
import app.puretech.e_sport.adapter.SchoolTrainerListYearlyPlannerAdapter;
...
public class SchoolYearlyPlannerTrainerListActivity extends AppCompatActivity {
    private App app;
    private Activity activity;
    private RecyclerView rv_show;
    private List<SchoolTrainerDailyReportDTO> array_list = new ArrayList<>();
    private SchoolTrainerListYearlyPlannerAdapter schoolTrainerDailyReportAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_school_yearly_planner_trainer_list);
        doInit();
    }
    ...
    private void setAdapter() {
        schoolTrainerDailyReportAdapter = new SchoolTrainerListYearlyPlannerAdapter(array_list, activity);
