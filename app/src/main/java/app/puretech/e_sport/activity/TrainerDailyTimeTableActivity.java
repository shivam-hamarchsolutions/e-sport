...
public class TrainerDailyTimeTableActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      /*  getWindow().setFlags(WindowManager.LayoutParams.FLAG_SECURE,
        ...
        setContentView(R.layout.activity_trainer_daily_time_table);
        doInit();
    }
    ...
    private void setAdapter() {
        trainerDailyTimeTableAdapter = new TrainerDailyTimeTableAdapter(array_list, activity, app, dialog,"trainer");
    ...
    private void getDailyTimeTable(String str_date) {
        ...
        AppPreferences.init(activity).setString("str_date",str_date);
                        ...
                        try {
                            ...
                            if (status.equals("0")) {
                                ...
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    trainerDailyTimeTableDTO.setStr_status(c.getInt("attendance_status"));
