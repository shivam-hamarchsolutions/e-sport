...
import app.puretech.e_sport.adapter.TrainerMonthlyPlannerAdapter;
import app.puretech.e_sport.model.TrainerMonthlyPlannerDTO;
...
public class TrainerMonthlyPlannerActivity extends AppCompatActivity {

    App app;
    Activity activity;
    private GridView rv_show;
    private List<TrainerMonthlyPlannerDTO> array_list = new ArrayList<>();
    private TrainerMonthlyPlannerAdapter trainerMonthlyPlannerAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      /*  getWindow().setFlags(WindowManager.LayoutParams.FLAG_SECURE,
        ...
        setContentView(R.layout.activity_trainer_monthly_planner);
        doInit();
    }
    ...
    private void doInit() {
        ...
        rv_show = findViewById(R.id.rv_trainer_monthly_planner);
        ...
        btn_next.setOnClickListener(v -> {
            ...
            Intent i_next = new Intent(activity, TrainerMonthlyPlannerSubActivity.class);
                        ...
                        try {
                            ...
                            if (status.equals("0")) {
                                ...
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    TrainerMonthlyPlannerDTO trainerMonthlyPlannerDTO = new TrainerMonthlyPlannerDTO();
                                    trainerMonthlyPlannerDTO.setTitle(c.getString("class"));
                                    array_list.add(trainerMonthlyPlannerDTO);
                                }
                                setAdapter();
    ...
    private void setAdapter() {
        trainerMonthlyPlannerAdapter = new TrainerMonthlyPlannerAdapter(array_list, activity);
        rv_show.setAdapter(trainerMonthlyPlannerAdapter);
        if (trainerMonthlyPlannerAdapter.getCount() == 0) {
