...
public class TrainerStudentAssessmentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* getWindow().setFlags(WindowManager.LayoutParams.FLAG_SECURE,
        ...
        setContentView(R.layout.activity_trainer_student_assessment);
        doInit();
        getClassDivision();
        btn_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i_next = new Intent(activity, TrainerStudentAssessmentListActivity.class);
