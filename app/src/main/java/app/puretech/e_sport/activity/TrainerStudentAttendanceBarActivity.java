...
public class TrainerStudentAttendanceBarActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_trainer_student_attendance_bar);
        doInit();
    }
    ...
    private void doInit() {
        ...
        getTrainerBarData(AppPreferences.init(activity).getString("trainer_id", ""));
        tv_avg = findViewById(R.id.tv_avg);
    }

    private void getTrainerBarData(String str_trainer_id) {
        if (CommonUtil.isNetworkAvailable(activity)) {
            ...
            RequestBody requestBody = new MultipartBuilder()
                    ...
                    .build();
            app.getApiService().getTrainerAttendanceBar(requestBody).enqueue(new Callback<Map<String, Object>>() {
                @Override
                        ...
                        try {
                            ...
                            if (status.equals("0")) {
                                ...
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    assessmentActivityDTO.setStr_school_id(c.getString("school_id"));
                                    assessmentActivityDTO.setStr_trainer_id(c.getString("trainer_id"));
...
//        chart.setRenderer(roundedBarChartRenderer);
            ...
            public void onValueSelected(Entry e, int dataSetIndex, Highlight h) {
                for (int i = 0; i < arrayList.size(); i++) {
                    ...
                    if (str_month.equals(NameOfYear.get(h.getXIndex()))) {
                        AppPreferences.init(activity).setString("trainer_id", arrayList.get(i).getStr_trainer_id());
                        AppPreferences.init(activity).setString("month", arrayList.get(i).getStr_month());
                        Intent i_next = new Intent(getApplicationContext(), SchoolTrainerAttendanceCalActivity.class);
    ...
    public void onBackPressed() {
        Intent i = new Intent(activity, TrainerStudentAttendenceActivityNew.class);
