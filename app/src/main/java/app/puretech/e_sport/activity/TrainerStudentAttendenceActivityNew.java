...
public class TrainerStudentAttendenceActivityNew extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_trainer_student_attendence_new);
        doInit();
        getClassDivision();
        btn_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i_next = new Intent(activity, TrainerStudentListActivity.class);
