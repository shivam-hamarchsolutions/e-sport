...
public class TrainerYearlyPlannerMonthActivity extends AppCompatActivity {

    App app;
    Activity activity;
    private RecyclerView rv_show;
    private List<TrainerYearlyPlannerMonthDTO> array_list = new ArrayList<>();
    private TrainerYearlyPlannerMonthAdapter trainerYearlyPlannerMonthAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      /*  getWindow().setFlags(WindowManager.LayoutParams.FLAG_SECURE,
        ...
        setContentView(R.layout.activity_trainer_yearly_planner_month);
        doInit();
    }
    ...
    private void setAdapter(){
        trainerYearlyPlannerMonthAdapter = new TrainerYearlyPlannerMonthAdapter(array_list, activity);
        RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(getApplicationContext());
        rv_show.setLayoutManager(mLayoutManager);
        rv_show.setItemAnimator(new DefaultItemAnimator());
        rv_show.setAdapter(trainerYearlyPlannerMonthAdapter);
        if (trainerYearlyPlannerMonthAdapter.getItemCount() == 0) {
