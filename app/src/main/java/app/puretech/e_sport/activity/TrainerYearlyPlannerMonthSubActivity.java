...
public class TrainerYearlyPlannerMonthSubActivity extends AppCompatActivity {

    App app;
    Activity activity;
    private RecyclerView rv_show;
    private List<TrainerYearlyPlannerMonthSubDTO> array_list = new ArrayList<>();
    private TrainerYearlyPlannerMonthSubAdapter trainerYearlyPlannerMonthSubAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     /*   getWindow().setFlags(WindowManager.LayoutParams.FLAG_SECURE,
        ...
        setContentView(R.layout.activity_trainer_yearly_planner_month_sub);
        doInit();
    }
    ...
    private void doInit() {
        ...
        i_back = new Intent(activity, TrainerYearlyPlannerActivity.class);
        swipRefresh(s_Refresh);
        doBack(toolbar);
        getYearlyPlanner(AppPreferences.init(activity).getString("month",""),
                AppPreferences.init(activity).getString("class",""),AppPreferences.init(activity).getString("trainer_id",""));
    }
    private void getYearlyPlanner(String str_month, String str_class, String trainer_id) {
        if (CommonUtil.isNetworkAvailable(activity)) {
            ...
            RequestBody requestBody = new MultipartBuilder()
                    ...
                    .addFormDataPart("trainer_id", trainer_id)
    ...
    private void setAdapter(){
        trainerYearlyPlannerMonthSubAdapter = new TrainerYearlyPlannerMonthSubAdapter(array_list, activity);
        RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(getApplicationContext());
        rv_show.setLayoutManager(mLayoutManager);
        rv_show.setItemAnimator(new DefaultItemAnimator());
        rv_show.setAdapter(trainerYearlyPlannerMonthSubAdapter);
        if (trainerYearlyPlannerMonthSubAdapter.getItemCount() == 0) {
