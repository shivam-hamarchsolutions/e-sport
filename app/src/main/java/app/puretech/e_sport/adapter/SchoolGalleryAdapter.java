...
public class SchoolGalleryAdapter extends BaseAdapter {

    private List<SchoolGalleryDTO> array_list;
    private Activity activity;

    public SchoolGalleryAdapter(List<SchoolGalleryDTO> array_list, Activity activity) {
