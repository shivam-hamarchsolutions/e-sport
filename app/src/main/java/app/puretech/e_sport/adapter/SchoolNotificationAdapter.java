...
public class SchoolNotificationAdapter extends RecyclerView.Adapter<SchoolNotificationAdapter.ViewHolder> {

    private List<SchoolNotifactionDTO> array_list;
    private Activity activity;

    public SchoolNotificationAdapter(List<SchoolNotifactionDTO> array_list, Activity activity) {
    ...
    @NonNull
    @Override
    public SchoolNotificationAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View itemView = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.trainer_notification_item, viewGroup, false);

        return new SchoolNotificationAdapter.ViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull SchoolNotificationAdapter.ViewHolder viewHolder, int position) {
