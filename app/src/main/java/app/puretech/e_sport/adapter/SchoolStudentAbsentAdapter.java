...
public class SchoolStudentAbsentAdapter extends BaseAdapter {
    private Activity context; //context
    private ArrayList<SchoolStudentAbsentDTO> items; //data source of the list adapter

    //public constructor
    public SchoolStudentAbsentAdapter(Activity context, ArrayList<SchoolStudentAbsentDTO> items) {
