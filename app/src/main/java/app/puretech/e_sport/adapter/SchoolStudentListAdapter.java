...
import app.puretech.e_sport.activity.SchoolStudentAttendanceBarActivity;
import app.puretech.e_sport.model.SchoolStudentListDTO;
import app.puretech.e_sport.utill.AppPreferences;

public class SchoolStudentListAdapter extends RecyclerView.Adapter<SchoolStudentListAdapter.ViewHolder> {

    private List<SchoolStudentListDTO> array_list;
    private Activity activity;

    public SchoolStudentListAdapter(List<SchoolStudentListDTO> array_list, Activity activity) {
    ...
    @NonNull
    @Override
    public SchoolStudentListAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View itemView = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.school_student_list_item, viewGroup, false);

        return new SchoolStudentListAdapter.ViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull SchoolStudentListAdapter.ViewHolder viewHolder, int position) {
        ...
        viewHolder.btn_view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i_view = new Intent(activity, SchoolStudentAttendanceBarActivity.class);
