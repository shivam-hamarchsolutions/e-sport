...
public class SchoolTrainerDailyTimeTableAdapter extends RecyclerView.Adapter<SchoolTrainerDailyTimeTableAdapter.ViewHolder> {

    private List<SchoolTrainerDailyReportDTO> array_list;
    private Activity activity;

    public SchoolTrainerDailyTimeTableAdapter(List<SchoolTrainerDailyReportDTO> array_list, Activity activity) {
    ...
    @NonNull
    @Override
    public SchoolTrainerDailyTimeTableAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View itemView = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.school_trainer_daily_report_item, viewGroup, false);

        return new SchoolTrainerDailyTimeTableAdapter.ViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull SchoolTrainerDailyTimeTableAdapter.ViewHolder viewHolder, int position) {
        ...
        viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(activity, SchoolDailyTimeTableActivity.class);
