...
public class SchoolTrainerListYearlyPlannerAdapter extends RecyclerView.Adapter<SchoolTrainerListYearlyPlannerAdapter.ViewHolder> {

    private List<SchoolTrainerDailyReportDTO> array_list;
    private Activity activity;

    public SchoolTrainerListYearlyPlannerAdapter(List<SchoolTrainerDailyReportDTO> array_list, Activity activity) {
    ...
    @NonNull
    @Override
    public SchoolTrainerListYearlyPlannerAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View itemView = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.school_trainer_daily_report_item, viewGroup, false);

        return new SchoolTrainerListYearlyPlannerAdapter.ViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull SchoolTrainerListYearlyPlannerAdapter.ViewHolder viewHolder, int position) {
        ...
        viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(activity, SchoolYearlyPlannerActivity.class);
