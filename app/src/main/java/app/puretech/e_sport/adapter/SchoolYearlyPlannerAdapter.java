...
import app.puretech.e_sport.activity.SchoolYearlyPlannerMonthActivity;
...
public class SchoolYearlyPlannerAdapter extends BaseAdapter {

    private List<TrainerYearlyPlannerDTO> array_list;
    private Activity activity;

    public SchoolYearlyPlannerAdapter(List<TrainerYearlyPlannerDTO> array_list, Activity activity) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        convertView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i_next = new Intent(activity, SchoolYearlyPlannerMonthActivity.class);
