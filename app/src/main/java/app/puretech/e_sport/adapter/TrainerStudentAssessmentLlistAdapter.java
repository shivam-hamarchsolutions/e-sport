...
public class TrainerStudentAssessmentLlistAdapter extends RecyclerView.Adapter<TrainerStudentAssessmentLlistAdapter.ViewHolder> {

    private List<TrainerSchoolAssessmentListDTO> array_list;
    private Activity activity;

    public TrainerStudentAssessmentLlistAdapter(List<TrainerSchoolAssessmentListDTO> array_list, Activity activity) {
    ...
    @NonNull
    @Override
    public TrainerStudentAssessmentLlistAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View itemView = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.trainer_student_assessment_list_item, viewGroup, false);

        return new TrainerStudentAssessmentLlistAdapter.ViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull TrainerStudentAssessmentLlistAdapter.ViewHolder viewHolder, int position) {
        ...
        viewHolder.tv_view_assessment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i_next = new Intent(activity, TrainerStudentActivityAssessmentActivity.class);
