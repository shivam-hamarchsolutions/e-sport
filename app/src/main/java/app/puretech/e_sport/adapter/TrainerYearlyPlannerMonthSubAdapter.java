...
public class TrainerYearlyPlannerMonthSubAdapter extends RecyclerView.Adapter<TrainerYearlyPlannerMonthSubAdapter.ViewHolder> {

    private List<TrainerYearlyPlannerMonthSubDTO> array_list;
    private Activity activity;

    public TrainerYearlyPlannerMonthSubAdapter(List<TrainerYearlyPlannerMonthSubDTO> array_list, Activity activity) {
    ...
    @NonNull
    @Override
    public TrainerYearlyPlannerMonthSubAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View itemView = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.trainer_yearly_planner_month_sub_item, viewGroup, false);

        return new TrainerYearlyPlannerMonthSubAdapter.ViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull TrainerYearlyPlannerMonthSubAdapter.ViewHolder viewHolder, int position) {
